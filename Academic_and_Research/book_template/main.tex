...
% ---- Fonts ----
% Amiri is a high-quality Arabic font shipped with TeX Live.
% If you want a different font, replace "Amiri-Regular.ttf" with
% the filename of your preferred .ttf/.otf font (must be findable
