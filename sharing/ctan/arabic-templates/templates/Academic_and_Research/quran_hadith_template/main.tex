...
%
%  Requires: XeLaTeX, Amiri + Amiri Quran fonts, quran package
...
هذا قالبٌ لإعداد الوثائق الإسلامية التي تحتوي على آيات قرآنية وأحاديث نبوية مع التعليق العلمي. يستخدم القالب حزمة \LR{\texttt{quran}} لاستدعاء الآيات مباشرةً، وخط \LR{Amiri Quran} لعرض النص القرآني بشكلٍ مناسب.
